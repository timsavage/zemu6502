...
;macros to set (register|memory|zeropage) & status
        .macro set_stat           ;setting flags in the processor status register
            load_flag \1
            pha         ;use stack to load status
            plp
        .endmacro

        .macro set_a              ;precharging accu & status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_x              ;precharging index & status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_y              ;precharging index & status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_ax             ;precharging indexed accu & immediate status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_ay             ;precharging indexed accu & immediate status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_z              ;precharging indexed zp & immediate status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_abs            ;precharging indexed memory & immediate status
            load_flag \2
            pha         ;use stack to load status
        ...
        .macro set_absx           ;precharging abs,x & immediate status
            load_flag \2
            pha         ;use stack to load status
...
;macros to test (register|memory|zeropage) & status & (mask)
        .macro tst_stat           ;testing flags in the processor status register
            php         ;save status
        ...
        .macro tst_a              ;testing result in accu & flags
            php         ;save flags
            cmp #\1     ;test result
            trap_ne
            pla         ;load status
        ...
        .macro tst_x              ;testing result in x index & flags
            php         ;save flags
            cpx #\1     ;test result
            trap_ne
            pla         ;load status
        ...
        .macro tst_y              ;testing result in y index & flags
            php         ;save flags
            cpy #\1     ;test result
            trap_ne
            pla         ;load status
        ...
        .macro tst_ax             ;indexed testing result in accu & flags
            php         ;save flags
            cmp \1,x    ;test result
            trap_ne
            pla         ;load status
        ...
        .macro tst_ay             ;indexed testing result in accu & flags
            php         ;save flags
            cmp \1,y    ;test result
            trap_ne     ;
            pla         ;load status
        ...
        .macro tst_z              ;indexed testing result in zp & flags
            php         ;save flags
            lda zpt
            cmp \1,x    ;test result
            trap_ne
        ...
        .macro tst_zx             ;testing result in zp,x & flags
            php         ;save flags
            lda zpt,x
            cmp \1,x    ;test result
            trap_ne
        ...
        .macro tst_abs            ;indexed testing result in memory & flags
            php         ;save flags
            lda abst
            cmp \1,x    ;test result
            trap_ne
        ...
        .macro tst_absx           ;testing result in abs,x & flags
            php         ;save flags
            lda abst,x
            cmp \1,x    ;test result
            trap_ne
