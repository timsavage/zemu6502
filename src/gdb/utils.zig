...
pub fn hexDigits(value: u8) [2]u8 {
    ...
    return ("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F" ++
        ...
        "E0E1E2E3E4E5E6E7E8E9EAEBECEDEEEFF0F1F2F3F4F5F6F7F8F9FAFBFCFDFEFF")[offset..][0..2].*;
}

test "hexDigits" {
    try std.testing.expectEqualStrings("5D", &hexDigits(0x5D));
    try std.testing.expectEqualStrings("E4", &hexDigits(0xE4));
}
